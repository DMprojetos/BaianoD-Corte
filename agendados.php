            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card info-card sales-card">
                        <div class="card-body">
                            <h5 class="card-title">BaianoDúCorte</h5>
    ...
    <form id="concluirForm">
        <div class="mb-3">
            ...
            <select class="form-select" id="tipoServico" onchange="atualizarPreco()" required>
                ...
                <option value="1" data-preco="40.00">Corte de Cabelo</option>
                <option value="2" data-preco="35.00">Barba</option>
                <option value="3" data-preco="10.00">Sobrancelha</option>
                <option value="4" data-preco="65.00">Cabelo e Barba</option>
                <option value="5" data-preco="25.00">Maquina</option>
            </select>
        </div>
