<?php
require_once "../config/configbaiano.php";
            ...
            <ul class="d-flex align-items-center">
                ...
                <li class="nav-item dropdown pe-3">
                    ...
                    <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                        <img src="../assets/img/logobaiano.png" class="rounded-circle">
                        <span
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <form action="atender.php" method="POST" id="form-atendimento">
                                    ...
                                    <div class="col-12">
                                        <div id="select-container">
                                            <div class="form-group">
                                                <label for="profissional" class="card-title w-100 text-center">Escolha o Profissional</label>
                                                <select class="form-select" name="profissional" id="profissional">
                                                    <option value="">Selecione um profissional</option>
                                                    <option value="baiano">Baiano</option>
                                                    <option value="gabriel">Gabriel</option>
                                                    <option value="guilherme">Guilherme</option>
                                                    <!-- Adicione mais opções se houver outros profissionais -->
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <br>
                                <!-- Seleção de pagamento e botões de ação (permanecem inalterados) -->
                                <div class="row">
                                    <div class="col-12" style="text-align: center;">
                                        <div id="select-container">
                                            <label for="pagamento" class="card-title w-100 text-center">Selecione o método de pagamento</label>
